...
public class _05_VariableNaming {
    public static void main(String[] args) {
        ...
        String firstName = "창호"; // 이름
        String lastName = "박"; // 성
        String dateOfBirth = "1996-07-18"; // 생년월일
        String residentialAddress = "파라다이스 호텔"; // 체류지
        String purposeOfVisit = "관광"; // 입국목적
        String flightNo = "KAL-718"; // 항공 편명
        String _flightNo = "KAL-718"; // 밑줄 시작
        String flight_no_2 = "KAL-718"; // 밑줄과 숫자 포함
//        String -flightNo = "KAL-718";
