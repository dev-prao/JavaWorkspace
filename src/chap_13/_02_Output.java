...
//        System.out.printf("포맷",값1, 값2, 값3, 값4, ...);
        System.out.printf("%d%n", 1); // %n : 어떤 OS에서도 통용되는 줄바꿈, // 1
        System.out.printf("%d %d %d %n", 1, 2, 3); // 1 2 3
        System.out.printf("%d%n", 1234); // 1234
        System.out.printf("%6d%n", 1234); // __1234 (6자리의 공간을 확보 후 1234 출력)
        System.out.printf("%06d%n", 1234); // 001234 (6자리의 공간을 확보 후 1234 출력, 빈공간 0)
        ...
        System.out.printf("%6.2s%n", "Java"); // ____Ja (6자리 공간 확보, 우측 정렬해서 앞 2글자만 출력)
        System.out.printf("%-6.2s%n", "Java"); // Ja____ (6자리 공간 확보, 우측 정렬해서 앞 2글자만 출력)
